...
You would be presented with a toolchain view. Check that the selected region is `London` and under `Delivery Pipeline` fill in the empty slots by pressing the `Create` button. <br/>
